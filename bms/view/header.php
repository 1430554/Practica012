<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="view/css/cssGenerar.css">		
        ...
        <script src="view/js/jquery.dataTables.js" type="text/javascript"></script>
        <script src="view/js/dataTables.bootstrap4.js" type="text/javascript"></script>
	</head>
	<body background="view/images/fondo.jpg">
		<center>
